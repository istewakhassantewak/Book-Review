...
const ListedBook = ({ book }) => {
    ...
    return (
        <div className="grid md:grid-cols-6 bg-base-100 shadow-sm rounded-lg">
            <figure className="p-7 md:col-span-2 bg-[#1313130D] m-4 rounded-lg flex justify-center">
                <img
                    src={image} className="h-60 w-56"
                    alt="Movie" />
            </figure>
            <div className="flex md:col-span-4 flex-1 flex-col justify-center space-y-4 p-4">
                <h2 className="font-bold text-2xl">{bookName}</h2>
                <p className="font-medium text-base text-[#131313CC]">By : {author}</p>
                <div className="flex flex-col md:flex-row gap-5 mb-4 items-center">
                ...
                <div className="flex flex-col md:flex-row gap-2.5">
                    ...
                    <NavLink to={`/${bookId}`}><button className="btn text-white bg-[#23BE0A] rounded-4xl py-6 w-full">View Details</button></NavLink>
